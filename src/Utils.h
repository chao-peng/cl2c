...
public:
    ...
    static int alert(const std::string& message, const char* const colour, const int& msg_type);
    static int alert(const std::stringstream& messagestream, const char* const colour, const int& msg_type);
