...
class ASTFrontendActionForKernelTranslator : public ASTFrontendAction {
public:
    ASTFrontendActionForKernelTranslator() {}
    ...
    void EndSourceFileAction() override {
        ...
        std::string filename = currentFile + "." + kernel_translator_constants::C_CODE_FILENAME_SUFFIX;
...
int parseCode(clang::tooling::ClangTool* tool){
    tool->run(newFrontendActionFactory<ASTFrontendActionForKernelTranslator>().get());
